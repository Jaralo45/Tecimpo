    ...
    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
      ...
      <div class="col-lg-10 mt-4">
        ...
        <div class="row">
          ...
          <?php }else if($producto["categoria"]!=5){ 
            echo('<h4 class="text-center text-success mt-5">En este momento no tenemos productos disponibles para esta categoría</h4>');
            echo('<h4 class="text-center text-success">Te invitamos a revisar nuestros demás productos</h4>');
            break; } ?>
          <?php endforeach?>
